...
import NativePrimeFunction from './specs/NativePrimeFunction'
...
export default function App() {
  ...
  const getKotlinPrime = async ()=>{
      try{
          const primeObj = await NativePrimeFunction.getPrimeNumbers(Number(number));
          console.log("mm: ", primeObj)
           setComputing(false)
      }catch(e){
          console.log(e)
      }
...
<View style={{marginTop: 100}}>
    <TextInput style={{width: "100%", height: 40, borderRadius: 10, padding: 10, fontSize: 16, fontWeight: "600", color: "#FFFFFF", borderColor: "#FFFFFF", borderWidth: 2}} placeholder='Enter large number' placeholderTextColor={"#FFFFFF"} value={number} onChangeText={setNumber} keyboardType="decimal-pad" />
</View>
